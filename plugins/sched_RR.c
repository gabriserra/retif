...
/*
static int count_unique_priorities(struct rtf_plugin* this, struct rtf_taskset* ts, unsigned int cpu, struct rtf_taskset* rr_tasks)
{
...
void rtf_plg_task_schedule(struct rtf_plugin* this, struct rtf_taskset* ts, struct rtf_task* t)
{
    ...
    else
    {
        ...
        // else
            rtf_task_set_real_priority(t, rtf_task_get_real_priority(
