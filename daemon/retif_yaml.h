...
static inline YAML_GET(string, char *);
static inline YAML_GET(long, long);
static inline YAML_GET(bool, bool);
static inline YAML_GET(double, double);
...
static inline int yaml_get_string(const yaml_document_t *document,
    const yaml_node_t *node, char **output_value)
{
    const char *ptr;
    char *newptr;
    size_t length;
...
static inline int string_to_long(char *strvalue, long *out)
{
    char *endptr;
    long value;
    int ret = 0;
...
static inline int string_to_double(char *strvalue, double *out)
{
    char *endptr;
    double value;
    int ret = 0;
...
static inline int string_to_bool(char *strvalue, bool *out)
{
    int ret = 0;
...
static inline int yaml_get_long(const yaml_document_t *document,
    const yaml_node_t *node, long *output_value)
{
    char *strvalue = NULL;
    int ret = 0;
...
static inline int yaml_get_double(const yaml_document_t *document,
    const yaml_node_t *node, double *output_value)
{
    char *strvalue = NULL;
    int ret = 0;
    ...
    ret = string_to_double(strvalue, output_value);
    if (ret)
        goto end;
...
static inline int yaml_get_bool(const yaml_document_t *document,
    const yaml_node_t *node, bool *output_value)
{
    char *strvalue = NULL;
    int ret = 0;
...
static inline int yaml_parse_mapping(yaml_document_t *document,
    yaml_node_t *node, const yaml_parser_map_t *keys, const size_t keys_size,
    void *out)
{
    char *key = NULL;
    bool found;
...
static inline int yaml_parse_list(yaml_document_t *document, yaml_node_t *node,
